    ...
    private func present(with parameter: PresentParameter) {
        ...
        DispatchQueue.main.async {
            ...
            if let centerValue = centerValue {
                ...
                finalContainerFrame.origin.x = layout.horizontal.originValue(withBound: self.bounds, containerRect: containerFrame)
                
                containerAutoresizingMask = layout.horizontal.autoresizingMask(with: containerAutoresizingMask)

                // Vertical
                
                finalContainerFrame.origin.y = layout.vertical.originValue(withBound: self.bounds, containerRect: containerFrame)
